...
# Define paths
mkdocs_file_path = (current_dir / "../../mkdocs.yml").resolve()
docs_base_path = (current_dir / "../../docs").resolve()
meta_file_path = (current_dir / "../../samplefiles/.meta.yml").resolve()
index_sample_file_path = (current_dir / "../../samplefiles/index_sample.md").resolve()
content_sample_file_path = (current_dir / "../../samplefiles/contentpage_sample.md").resolve()
